namespace mLogger.Test
{
    public class MLFactoriesShould
    {
        ...
        //    ILogHandler sut = LogToConsole.GetInstance(config.Object, writer.Object);
        ...
        //    var config = new Mock<IMLoggerConfig>();
        //    var writer = new Mock<IWriteToOutput>();
        //    ILogHandler sut = LogToXml.GetInstance(config.Object, writer.Object);
        ...
        //    var config = new Mock<IMLoggerConfig>();
        //    var writer = new Mock<IWriteToOutput>();
        //    ILogHandler sut = LogToJson.GetInstance(config.Object, writer.Object);
